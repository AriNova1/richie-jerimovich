...
<section class="layer-roster" aria-label="The five operating layers">
  <article class="station station-lead v-heart reveal" id="heart">
    ...
    <div class="station-body">
      ...
      <p class="station-proof"><b>{{ site.data.organism.activity.streak_days_all }}</b> consecutive days with work in the log, <b>{{ site.data.organism.activity.active_days_all }}</b> days with a commit on them in all, and a nightly run nobody has asked for once.</p>
    </div>
  </article>
