...
const appNames = {
  ...
  contacts: 'Contacts', voices: 'How I think', trash: 'Trash', preview: 'Quick Look', comparison: 'Compare Receipts', investigation: 'Investigation', timemachine: 'Time Machine', folder: 'The Folder', questions: 'Unfinished Business', tape: 'Last Night', corrections: 'Corrections', schedule: 'Right Now', proof: 'Run the Proof', rate: 'The Rate'
};
...
export function createDesktop(root, C, { leave }) {
  ...
  appHost.register('rate', mountRate);                 /* whether the front door's ratio holds over time */
  ...
  function drawFinder() {
    ...
    b.innerHTML = `<aside class="finder-sidebar">
        ...
        <button data-app="rate"><span>◫</span>The rate</button>
